...
<div id="PanelTitle" class="smallTitle">
	<?php echo anchor("","Home", array('class' => 'sitemap'));?>&nbsp;\&nbsp;<?php echo anchor("contact","Contact Us",array('class' => 'sitemap'));?>&nbsp;\&nbsp;<b>Request for Messenger Form</b>
</div>
	...
	<div id="contentInfo1">
		...
		<div class="field">
			...
			<select name="purpose">
				...
				<option <?php echo set_select('purpose', $row['id']); ?>  value="<?php echo $row['id'];?>"><?php echo $row['sub_group']; ?></option>
				<?php endforeach; ?>
			</select>
...
$(document).ready(function() {
	$("#form").validate({
		...
		rules: { 
			...
			purpose: {required: true , is_natural: true}
		},
		messages: {
