...
<?php 
	...
	<div class="control-group">
		...
		<div class="controls">
			<input class="input-xxlarge" type="text" name="title" value="<?php echo set_value('title'); ?>">
	...
	<div class="control-group">
		...
		<div class="controls">
			<textarea  class="input-xxlarge" rows="6" name="responsibilities"><?php echo set_value('responsibilities'); ?></textarea>
	...
	<div class="control-group">
		...
		<div class="controls">
			<textarea  class="input-xxlarge" rows="6" name="qualification"><?php echo set_value('qualification'); ?></textarea>
