...
<div id="PanelTitle" class="smallTitle">
	<?php echo anchor("","Home", array('class' => 'sitemap'));?>&nbsp;\&nbsp;<?php echo anchor("contact","Contact Us",array('class' => 'sitemap'));?>&nbsp;\&nbsp;<b>Clarification Form</b>
</div>
<div id="leftContainer">
	<?php echo $this->session->flashdata('msg');?>
	<div id="contentInfo1">
		<p>To file a clarification request, please complete the following fields and submit the form.</p>
		<br/>
		...
		<div class="field">
			<label class="meduim" for="inquired">Products Inquired</label>
			<input maxlength="35" class="input" id="inquired" name="inquired" type="text" value="<?php echo set_value('inquired');?>"/>
			<?php echo form_error('inquired'); ?>
		</div>
		...
		<div class="field" style="padding-bottom:5px;">
			<b><label for="product">Questions (things to clarify)</label></b>
			<br/>
		</div>
		<div class="field">
