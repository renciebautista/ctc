...
<div id="PanelTitle" class="smallTitle">
	<?php echo anchor("","Home", array('class' => 'sitemap'));?>&nbsp;\&nbsp;<?php echo anchor("contact","Contact Us",array('class' => 'sitemap'));?>&nbsp;\&nbsp;<b>Closed Sales Request Form</b>
</div>
...
$(document).ready(function() {
	...
	// $('#files').MultiFile({
	// 		STRING: {
	// 			remove: '<img src="<?php echo base_url('assets/images/delete.png');?>" height="16" width="16" alt="x"/>'
	// 		},
	// 		onFileSelect: function(element, value, master_element){ 
	// 			console.log(master_element.E); 
	// 		} 
	// 	});
