...
<div id="PanelTitle" class="smallTitle">
	<?php echo anchor("","Home", array('class' => 'sitemap'));?>&nbsp;\&nbsp;<?php echo anchor("contact","Contact Us",array('class' => 'sitemap'));?>&nbsp;\&nbsp;<b>Quotation Follow-Up Request Form</b>
</div>
<div id="leftContainer">
	<?php echo $this->session->flashdata('msg');?>
	<div id="contentInfo1">
		<p>To file a quotation follow-up request, please complete the following fields and submit the form.</p>
		<br/>
		...
		<div class="field">
			<label class="meduim" for="q_date">Exp. Date of Quotat'n</label>
			<input maxlength="35" class="input" id="q_date" name="q_date" type="text" value="<?php echo set_value('q_date');?>"/>
		...
		<div class="field" style="padding-bottom:5px;">
			<b><label for="product">Items Required in the Quotation</label></b>
			<br/>
		</div>
		<div class="field">
