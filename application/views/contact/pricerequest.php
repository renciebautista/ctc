...
<div id="PanelTitle" class="smallTitle">
	<?php echo anchor("","Home", array('class' => 'sitemap'));?>&nbsp;\&nbsp;<?php echo anchor("contact","Contact Us",array('class' => 'sitemap'));?>&nbsp;\&nbsp;<b>Price Request Form</b>
</div>
<div id="leftContainer">
	<?php echo $this->session->flashdata('msg');?>
	<div id="contentInfo1">
		<p>To file a price request, please complete the following fields and submit the form.</p>
		<br/>
		...
		<div class="field" style="padding-bottom:5px;">
			<b><label for="address">Other Information</label></b>
			<br/>
		</div>
		<div class="field">
			<div style="margin-left:10px;">
			   <em style="color:#DD4B39;">Please list other informations so that we can help you more, thank you.</em>
			</div>
